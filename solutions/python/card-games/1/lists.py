...
def approx_average_is_average(hand):
    ...
    # if len(hand) // 2 == card_average(hand):
    #     return True
    # if (int(hand[0]) + int(hand[-1])) / 2 == card_average(hand):
    #     return True
    # elif len(hand) / 2 == card_average(hand):
    #     return True
    # else:
    #     return False
    
    return card_average(hand) == (int(hand[0]) + int(hand[-1])) / 2 or card_average(hand) == hand[len(hand) // 2]
